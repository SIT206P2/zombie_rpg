...
class UI {
    constructor(audio, events) {
        ...
        this.dialogs = {
            ...
            "tips"          : "There are two types of zombis: an Elder, and the Shoggoths. The Elder creates a Shoggoth every turn and must be attacked three times to kill it.  While the Elder cannot attack, the Shoggoths can.  Each Shoggoth will attack if you approach within one square of it, but can be killed with one hit.  Every turn you are next to any zombi, you will lose some sanity for each zombi you're next to.\n\nThere are three levels in the dungeon.  Be sure to explore all of them!\n\nYour final score is calculated from the amount of remaining health, remaining sanity, number of zombis you kill, whether you find the Elder Sign, whether you kill the Elder, and whether you win the game (killing all zombis in the dungeon).",
            ...
            "score"         : "How are your zombi slaying skills?",
    ...
    // add conditional for checking online status - if none, display error message
        ...
        el.append('<div><span class="score-headers">Zombis slain: </span><span class="score score-text">' + scores.kills + '</span></div>');
        ...
        el.append('<div id="leaderboard"><span class="score-text">Zombi Leaders</span></div>');
